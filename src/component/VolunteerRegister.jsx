...
const VolunteerRegister = () => {
  ...
  const [formdata, setFormdata] = useState({
    ...
    field_qid: "",
    field_student_dob: "",
    field_volenteer_email: "",
    field_volenteer_mobile: "",
    field_volenteer_name: "",
    field_volenteer_name_arabic: "",
    mail: "",
    name: "",
    roles: { target_id: "volenteer" },
    target_id: "volenteer",
    agree: false,
  });
  ...
  const handleValidate = () => {
    ...
    inputData.forEach((field) => {
      ...
      if (field.type == "select" && formdata[field.key] == "0") {
        newErrors[field] = t("School name is required");
      }
    });
    return newErrors;
  };
  ...
  const handleSubmit = (e) => {
    ...
    const updatedForm = {
      ...formdata,
      mail: formdata.field_volenteer_email,
      name: formdata.field_volenteer_email,
    };
    console.log("url: ", urls.volunteerEndpoint(lang));
    console.log("formData: ", updatedForm);
    axiosInstance
      .post(urls.volunteerEndpoint(lang), updatedForm)
      .then((res) => {
      ...
      <div id="skipContent" className="container registration-form">
        ...
        <div className="row">
          <div className="col s6 form-container">
            <p>
              {t("required-field")} <span className="asterisk">*</span>
            </p>
            ...
            <form autoComplete="off">
              {inputData.map((item, index) => (
                <div key={index}>{renderdField(item.key, item)}</div>
              ))}
